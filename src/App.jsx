      ...
      <Routes>
        ...
        <Route element={<ProtectedRoute />}>
          <Route path="/" element={<MainLayout />}>
            {/* Redirection racine protégée → tableau de bord */}
            ...
            <Route
              path="Impressions-Pelerins"
              element={<ImpressionsPelerins />}
            />

            {/* Enregistrement des offres */}
            <Route
              path="Enregistrement_Offres"
              element={<EnregistrementOffres />}
            />
            ...
            <Route
              path="impressions-passeports"
              element={<ImpressionsPasseports />}
            />
            ...
            <Route path="utilisateurs" element={<Utilisateurs />}>
              ...
              <Route
                path="historique"
                element={<HistoriqueConnexion />}
              />
              <Route
                path="inscription"
                element={<InscriptionUtilisateur />}
              />
            </Route>
